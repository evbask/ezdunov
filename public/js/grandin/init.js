...
var grandin = function(){
	...
	// });
 	...
 	function transformMenu(){
         ...
         if($('.page-wrapper').css('margin-left') == '44px'){
    ...
    //         $('.page-wrapper').css('margin-left', $('.fixed-sidebar-left').css('width'));
    //     });
    //
    // });
	...
	/*Slimscroll*/
	 ...
	 $('.nicescroll-bar').slimscroll({width: '100%',height:'100%',color: '#878787', disableFadeOut : true,borderRadius:0,size:'4px',alwaysVisible:false});
	 $('.nicescroll-bar').slimscroll({width: '100%', height:'100%',color: '#878787', disableFadeOut : true,borderRadius:0,size:'4px',alwaysVisible:false});
